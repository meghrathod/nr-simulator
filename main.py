...
def main(lock_mutex: threading.Lock, time_to_trigger: int,
         hysteresis: int) -> utils.Result.Result:
    ...
    try:
        ...
        utils.Result.Result.save_to_file(res, file_name, enbs[0],
...
def run_threads(time_to_trigger: int, hysteresis: int):
    ...
    for i in range(num_threads):
        ...
        thread = threading.Thread(target=main,
                                  args=(lock, time_to_trigger, hysteresis))
        thread.start()
